...
RUN apk add --no-cache g++ gcc gdb make cmake py3-pytest python3 valgrind bzip2-dev check-dev curl-dev json-c-dev libmilter-dev libxml2-dev linux-headers ncurses-dev wget openssl-dev pcre2-dev zlib-dev \
